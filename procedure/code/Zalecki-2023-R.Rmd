...
# as_acs$child <- c(as_acs$)
# as_acs$teen <- c(as_acs$)
# as_acs$yad <- c(as_acs$)
# as_acs$mad <- c(as_acs$)
# as_acs$sen <- c(as_acs$)
...
race_pop <- left_join(acs_tracts, tr_cent, by = "TRACTCE")%>%
...
left join acs tracts to blocks
need to get library names 
