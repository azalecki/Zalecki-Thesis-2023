...
saveRDS(ethn_acs, here("data", "raw", "public", "ethn_acs.RDS"))
...
ethn_acs <- readRDS(here("data", "raw", "public", "ethn_acs.RDS"))
...
# fn_trct <- dplyr::st_join(chi_tracts, group_tract2)
...
brks_prty <- classIntervals(m_inc_trct$m_inc_pc, 6, style = "jenks")$brks
...
tmap_mode("plot")
tm_shape(m_inc_trct) +
  tm_polygons(col="m_inc_pc", breaks=brks_prty, title="Med. Household Income", lwd= 0, border.col="lightgrey") +
...
tmap_mode("plot")
tm_shape(nat_pop) +
  tm_polygons(col="pctFor", title="Pct Foreign per Capita", lwd= 0, border.col="lightgrey") +
tm_layout(legend.width=3, legend.text.size = .6, legend.title.size = .8, asp=0.8)
