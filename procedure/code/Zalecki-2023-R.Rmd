...
as_tab <- as_acs %>% 
  dplyr::select(GEOID, child, teen, yad, mad, sen, t_male,t_fem)
>>>>>>> eb6a8a12de0e6e19bc6de4a68d02e6ea1a8367d8
...
tm_shape(catchment) +
  tm_polygons(col="white_app", style="jenks", title="LatinX Pop", lwd= NA, border.col="lightgrey") +
...
tm_shape(web.new) +
  tm_polygons("MHSS",palette = c("No" = "#ffd14d", "Yes" = "#df5454"), title="Mental Health", lwd= NA, border.col="lightgrey") +
  tm_layout(legend.width=3, legend.text.size = .6, legend.title.size = .8, asp=0.8)
